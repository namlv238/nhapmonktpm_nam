            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form:form action="/dangkykh" method="post" modelAttribute="dangkyKH">
                    <div class="form-group">
                      <form:input    type="text" path="tendangnhap" class="form-control form-control-user"
                    ...
                    <div class="form-group">
                      <form:input   type="text" path="hoten" class="form-control form-control-user"
                    ...
                    <div class="btn-group" data-toggle="buttons">
                      <label class="btn btn-primary active">
                        <input type="radio"  name="gioitinh" autocomplete="off" value="Nam"value="Nam" checked>Nam
                      </label>
                    ...
                    ${mes}
                    <button name="btn_dangkykh" class="btn btn-primary btn-user btn-block">
                      Đăng ký
                    </button>
                    <hr>
                  </form:form>
