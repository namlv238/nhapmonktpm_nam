            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="btndoimk" method="post">
                    <div class="form-group">
                      <input type="password" name="mkcu" class="form-control form-control-user"
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="mkmoi"
                        id="exampleInputPassword" placeholder="Mật khẩu mới" />
                    </div>

                    <div class="form-group">
                      <input type="text" name="mknhaplai" class="form-control form-control-user"
                    ...
                    ${mes}
                    <button name="btn_doimk" class="btn btn-primary btn-user btn-block">
                      Đổi mật khẩu
                    </button>
                    <hr>
                </form>
