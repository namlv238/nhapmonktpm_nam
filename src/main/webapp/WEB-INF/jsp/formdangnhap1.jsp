...
<head>
  ...
  <link href="${pageContext.servletContext.contextPath}/QL/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
                ...
                <div class="p-5">
                  ...
                  <form action="kiemtradangnhap" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="txt_tentk" aria-describedby="emailHelp" placeholder="Nhập tài khoản..."/>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="txt_mk" id="exampleInputPassword" placeholder="Nhập mật khẩu"/>
                    </div>
                    <div class="form-group">
                    ...
                    ${mes}
                    <button  name="dn" class="btn btn-primary btn-user btn-block">
                      Đăng nhập
                    </button>
                    <hr>
                  </form>
                  <div class="alert alert-secondary" role="alert">
                    <a href="/fromlaylaimk/" class="alert-link"> <strong>Lấy lại mật khẩu!</strong></a>
                  </div>
                </div>
              </div>
            </div>
